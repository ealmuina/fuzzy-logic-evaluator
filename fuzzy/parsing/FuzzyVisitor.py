...
class FuzzyVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by FuzzyParser#Sugeno.
    def visitSugeno(self, ctx: FuzzyParser.SugenoContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by FuzzyParser#Mamdani.
    def visitMamdani(self, ctx: FuzzyParser.MamdaniContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by FuzzyParser#Tsukamoto.
